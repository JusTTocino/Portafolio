                ...
                <li data-estado="<?= htmlspecialchars($j['estado']) ?>">
                    ...
                    <div class="tarjeta-header">
                        <span class="tarjeta-motivo">
                            <?php
                                $iconos = ['Medico' => '', 'Academico' => '', 'Familiar' => ''];
                                $motivo = $j['motivo'] ?? '';
                                $icono  = $iconos[$motivo] ?? '';
                    ...
                    <?php if (!empty($j['fecha_inicio']) && !empty($j['fecha_fin'])): ?>
                        <p class="tarjeta-fechas">Fechas: <strong><?= htmlspecialchars($j['fecha_inicio']) ?> a <?= htmlspecialchars($j['fecha_fin']) ?></strong></p>
                    <?php endif; ?>
                    ...
                    <div class="tarjeta-footer">
                        ...
                        <?php if (!empty($j['fecha_resolucion']) && $j['fecha_resolucion'] !== '0000-00-00'): ?>
